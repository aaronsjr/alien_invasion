...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        # Get rid of bullets that have ventured off screen.
    ...
    def _check_events(self):
        ...
        for event in pygame.event.get():
                ...
                elif event.type == pygame.KEYUP and self.stats.game_active == True:
    ...
    def _check_keydown_events(self, event):
        ...
        if event.key == pygame.K_RIGHT and self.stats.game_active == True:
            self.ship.moving_right = True
        elif event.key == pygame.K_LEFT and self.stats.game_active == True:
    ...
    def _create_fleet(self):
        ...
        avaliable_space_x = self.actual_screen_width - (2 * alien_width)
        number_aliens_x = avaliable_space_x // (2 * alien_width)

        # Determine the number of rows of aliens that fit on the screen.
        ship_height = self.ship.rect.height
        avaliable_space_y = self.actual_screen_height - (3 * alien_height) - ship_height
        number_rows = avaliable_space_y // (2 * alien_height) - 1
    ...
    def _check_fleet_edges(self):
        """Respond if aliens have reached edge of screen"""
